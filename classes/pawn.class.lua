...
CPawn = class(
	function (self, ptr)
		...
		--self.Class1 = pawns.settings["class_types"]["CLASS_NONE"];
		--self.Class2 = pawns.settings["class_types"]["CLASS_NONE"];
		-- end
